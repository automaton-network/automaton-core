#ifndef AUTOMATON_CORE_INTEROP_ETHEREUM_ETH_CONTRACT_RAW_H_
#define AUTOMATON_CORE_INTEROP_ETHEREUM_ETH_CONTRACT_RAW_H_
...
#endif  // AUTOMATON_CORE_INTEROP_ETHEREUM_ETH_CONTRACT_RAW_H_
